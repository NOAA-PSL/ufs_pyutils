...
class Template(object):
    ...
    def run(self, str_dict: dict, str_template: str) -> str:
        ...
        try:
            ...
            msg = ('Template string {0} parsing failed with error '
                   '{1}. Aborting!!!'.format(str_template, error))
            raise TemplateError(msg=msg)
...
class TemplateError(Error):
    ...
    def __init__(self, msg: str):
        ...
        """
        super(TemplateError, self).__init__(msg=msg)
